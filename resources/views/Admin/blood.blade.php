            ...
            <div class="screen__content">
                <form class="login" method="POST" enctype="multipart/form-data">
                    ...
                    @if (session()->get('car') == 'aradhana')
                        <p>{{ session()->get('district_name') }}</p>
                        <p>{{ session()->get('taluk_name') }}</p>


                        <select name="blood" id="">
                            <option value="">Blood</option>
                            @foreach ($user_names as $abc)
                                <option value="{{ $abc->blood }}">{{ $abc->blood }}</option>
                            @endforeach
                        </select>
                    ...
                    <p>{{ session()->get('taluk_name') }}</p> --}}
                        <select name="gender" id="">
                            ...
                            @foreach ($abcd as $abc)
                                <option value="{{ $abc->blood }}">{{ $abc->blood }}</option>
                            @endforeach
                            {{-- @foreach ($anssu as $abcd)
                        <option value="{{ $abcd->blood }}">{{ $abcd->blood}}</option>
                    @endforeach --}}
                        </select>
                    ...
                    {{-- @if (session()->get('car') == 'rahul')
                    <p>{{ session()->get('district_name') }}</p>
                    <p>{{ session()->get('taluk_name') }}</p>
ssession ..for each blade table..
                    <select name="gender" id="">
                        <table>
                            <tr>
                                <th>name</th>
